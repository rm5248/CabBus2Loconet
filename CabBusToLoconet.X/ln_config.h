...
#if defined( __XC32 ) || defined( __XC )
//This is a Microchip compiler.  So we're probably compiling for Microchip.
#include <plib.h>
#define MICROCHIP

#define LN_DISABLE_INTERRUPTS() INTDisableInterrupts()
#define LN_ENABLE_INTERRUPTS() INTEnableInterrupts()

//#define LN_TMR_COUNT_REG    ReadTimer1()
#else

#define LN_DISABLE_INTERRUPTS() cli()
#define LN_ENABLE_INTERRUPTS() sei()
